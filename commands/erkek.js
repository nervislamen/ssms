...
await db.push(`isimler?${kisi.user.id}`, `${kisi.nickname} (<@&${process.env.ERKEK_ROLE}>)`)
   await kisi.roles.add([process.env.ERKEK_ROLE, process.env.ERKEK_ROLE1])
   ...
   .setDescription(`${kisi} üyesine başarıyla <@&${process.env.ERKEK_ROLE}>, <@&${process.env.ERKEK_ROLE1}> rolleri verildi.`)
   )
